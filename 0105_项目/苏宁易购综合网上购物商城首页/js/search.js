...
(function($, window, document, undefined) {
	...
	SElecty.prototype = {
		...
		rootrender: function() {
			...
			var showm, multi;
			if(rootdata.showmore || rootdata.showmore == undefined) {} else {
				showm = "display:none";
			}
		...
		chilrender: function() {
			...
			for(var i = 0; i < childconditionsdata.length; i++) {
				...
				str += "</ul></div>";
				var shows, muls = '';
				if(childconditionsdata[i].showmore || childconditionsdata[i].showmore == undefined) {} else {
					shows = "display:none";
				}
